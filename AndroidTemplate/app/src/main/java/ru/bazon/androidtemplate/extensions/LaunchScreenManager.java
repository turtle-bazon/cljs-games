...
public class LaunchScreenManager
    ...
    public LaunchScreenManager(Activity activity) {
        mLibContext = activity;
        mActivity = activity;
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                int bgResId = mActivity.getResources().getIdentifier(
                        "splash_screen", "drawable", mActivity.getPackageName());
//                        "launchscreen_bg", "drawable", mActivity.getPackageName());
                ...
                mLaunchScreenDialog.getWindow().setFlags(WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE);
                ...
                mLaunchScreenDialog.setOnShowListener(LaunchScreenManager.this);
                mLaunchScreenDialog.setOnDismissListener(LaunchScreenManager.this);
                // Set background
                ...
                mLaunchScreenDialog.getWindow().getDecorView().setSystemUiVisibility(
