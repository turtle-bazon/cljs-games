(ns runner.core
  (:require [phzr.core :as p :refer [pset!]]
            ...
            [runner.boot-state :as boot-state]
            [runner.menu-state :as menu-state]
            [runner.play-state :as play-state]
            [runner.game-over-state :as game-over-state]
            [runner.utils :refer [log mobile?]]))
